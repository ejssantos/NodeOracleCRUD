...
async function run() {
  ...
  try {
    ...
    connection = await oracledb.getConnection({ user: "scmmweb", password: "scmmweb", connectionString: "172.20.0.225:1622/mvdev" });
    ...
    await connection.execute(`create table scmmweb.todoitem (
                                id number,
